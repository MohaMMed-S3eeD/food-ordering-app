...
export async function GET() {
    try {
        return NextResponse.json({ message: "Hello World", data: "Here is the data from the server upload route you can upload files to cloudinary using this route in POST request" });
    } catch (error) {
        console.error(error);
